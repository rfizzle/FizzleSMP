...
| Item Borders | TieredZ | Both relate to item rarity display (Item Borders colors inventory slots by rarity, TieredZ assigns random tier modifiers) | Complementary — Item Borders reads item rarity for slot coloring, TieredZ modifies item stats. Verify TieredZ tier changes are reflected in Item Borders colors. |
