...
| Gazebos | Towns and Towers | Both add village structures; Gazebos adds gazebos with Spell Binding Tables, T&T adds general village expansions | Complementary — different structure types injected via Structure Pool API. |
