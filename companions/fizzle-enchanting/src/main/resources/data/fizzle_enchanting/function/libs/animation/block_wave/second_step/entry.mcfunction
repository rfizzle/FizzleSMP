...
scoreboard players operation @s fizzle_enchanting.gametime.temp += #8 fizzle_enchanting.data
...
data merge entity @s {start_interpolation:0,interpolation_duration:7,transformation:{translation:[0.0f,-1.0f,0.0f],scale:[1.0f,1.0f,1.0f]}}
scoreboard players set @s fizzle_enchanting.animation_state 2