 ...
 * {@code fizzle_enchanting.json} see the new values on the next Warden kill after running
 * {@code /fizzleenchanting reload}; no full datapack reload is required.
 *
...
public final class WardenLootHandler {
    ...
    static void modify(LootTable.Builder tableBuilder, HolderLookup.Provider registries) {
        tableBuilder.withPool(LootPool.lootPool()
                ...
                .add(LootItem.lootTableItem(FizzleEnchantingRegistry.WARDEN_TENDRIL))
