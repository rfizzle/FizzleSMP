...
public final class TomeRecipeClassifier {
    ...
    public static boolean isTomeResult(ItemStack result) {
        return result.is(FizzleEnchantingRegistry.SCRAP_TOME)
                || result.is(FizzleEnchantingRegistry.IMPROVED_SCRAP_TOME)
                || result.is(FizzleEnchantingRegistry.EXTRACTION_TOME);
    }
